...
**Generated:** 2026-09-16 08:12:38 UTC  
...
| **Inference Latency (Single Tx)** | `0.14 ms` | `8.18 ms` | `8.50 ms` |
...
3. **Inference Speed:** XGBoost provides sub-millisecond single-transaction inference (`8.50 ms`), well within the 100ms real-time SLA.
